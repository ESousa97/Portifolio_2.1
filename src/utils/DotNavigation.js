...
function DotNavigation() {
  ...
  return (
    <div className={`dot-navigation ${isVisible ? 'visible' : 'hidden'}`}>
      <a
        href="#home"
        className={`dot ${activeSection === 'home' ? 'active icon' : ''}`}
      ...
      <a
        href="#about"
        className={`dot ${activeSection === 'about' ? 'active icon' : ''}`}
      ...
      <a
        href="#projects"
        className={`dot ${activeSection === 'projects' ? 'active icon' : ''}`}
      ...
      <a
        href="#skills"
        className={`dot ${activeSection === 'skills' ? 'active icon' : ''}`}
      ...
      <a
        href="#footer"
        className={`dot ${activeSection === 'footer' ? 'active icon' : ''}`}
        aria-label="Ir para Contacts"
        title="Ir para Contacts"
      >
