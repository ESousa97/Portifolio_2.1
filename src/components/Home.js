    ...
    <div className="home">
      ...
      <div className="column-left">
        ...
        <p ref={(el) => (paragraphRefs.current[0] = el)}>
          É um prazer tê-lo aqui! Este espaço foi cuidadosamente preparado para compartilhar minha
          trajetória e algumas das soluções em que venho trabalhando.
        </p>
        ...
        <div className="content-wrapper">
          ...
          <ul>
            ...
            <li>
              ...
              <span>
                Docker, AWS (ECS, RDS, ALB, Certificate Manager), GitHub Actions, Vercel, Render,
                Heroku, PgAdmin, Mongo Compass, Git CLI
              </span>
            </li>
            <li>
              <strong>Segurança:</strong>{' '}
              <span>NextAuth, JWT, OAuth 2.0, 2FA, CSRF, Helmet, DOMPurify, SSL/TLS, LGPD</span>
            </li>
            <li>
              <strong>Banco de Dados:</strong>{' '}
              <span>PostgreSQL, MongoDB, SQLite, MySQL, Sequelize, Mongoose, SQL Server</span>
            </li>
            <li>
              <strong>IA & NLP:</strong>{' '}
              <span>
                OpenAI (GPT-4), Google Gemini, Prompt Engineering, NLP com spaCy, Vetorização
                semântica, Automação Cognitiva com IA, Processamento de Texto, PyQt5, ctypes,
                winreg, WMI, PyWin32, PyAutoGUI, PyGetWindow e PyInstaller.
              </span>
            </li>
          </ul>
        </div>
